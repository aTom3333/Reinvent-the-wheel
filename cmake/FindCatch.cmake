...
function(_download_catch version destination_dir)
    ...
    set(url https://github.com/catchorg/Catch/releases/download/v${version}/catch.hpp)
    file(DOWNLOAD ${url} "${destination_dir}/catch.hpp" STATUS status)
    list(GET status 0 error)
    if(error)
        message(FATAL_ERROR "Could not download ${url}")
    endif()
    set(CATCH_INCLUDE_DIR "${destination_dir}" PARENT_SCOPE)
endfunction()
...
if(NOT CATCH_VERSION OR CATCH_VERSION VERSION_LESS ${Catch_FIND_VERSION})
        ...
        _get_catch_version()
        set(CATCH_INCLURE_DIR "${PROJECT_BINARY_DIR}/catch/")
    #else()
...
target_include_directories(Catch INTERFACE ${CATCH_INCLURE_DIR})
target_compile_features(Catch INTERFACE
                        cxx_alignas
                        cxx_alignof
                        cxx_attributes
                        cxx_auto_type
